...
const char* const kVersionString = "TSUnit V2.0";
...
private:
    unsigned int _runTestsCnt;
    unsigned int _failedTestsCnt;
    unsigned int _assertionsCnt;
    unsigned int _assertionsFailedCnt;
